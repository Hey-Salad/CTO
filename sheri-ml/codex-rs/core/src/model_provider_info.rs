...
impl ModelProviderInfo {
    ...
    pub fn create_gemini_provider() -> ModelProviderInfo {
        // Use Vertex AI endpoint by default (supports more models)
        // Alternative: "https://generativelanguage.googleapis.com/v1"
        ModelProviderInfo {
            name: "Google Gemini".into(),
            base_url: Some("https://aiplatform.googleapis.com/v1/publishers/google/models".into()),
